...
/**
 * Remove mIsPendingCleanup from source ItemTouchHelper
 *
 * http://stackoverflow.com/questions/31787272/android-recyclerview-itemtouchhelper-revert-swipe-and-restore-view-holder
 * https://gist.github.com/kukabi/f46e1c0503d2806acbe2
 */
 ...
 */
public class SwipeRemoveItemTouchHelper extends RecyclerView.ItemDecoration
     ...
     */
    public SwipeRemoveItemTouchHelper(Callback callback) {
        mCallback = callback;
    }
     ...
     * ItemTouchHelper
     * is attached.</li>
     * <li>{ ItemTouchHelper.Callback} must have dragging enabled.</li>
     ...
     * <li>{ ItemTouchHelper.Callback} must have swiping enabled.</li>
     * <li>There must be a previous touch event that was reported to the ItemTouchHelper
     * through RecyclerView's ItemTouchListener mechanism. As long as no other ItemTouchListener
     * grabs previous events,this should work as expected.</li>
     * </ul>
    ...
    public abstract static class Callback {
        ...
        private void onDraw(Canvas c, RecyclerView parent, ViewHolder selected,
                            List<SwipeRemoveItemTouchHelper.RecoverAnimation> recoverAnimationList,
                            int actionState, float dX, float dY) {
            final int recoverAnimSize = recoverAnimationList.size();
            for (int i = 0; i < recoverAnimSize; i++) {
                final SwipeRemoveItemTouchHelper.RecoverAnimation anim = recoverAnimationList.get(i);
                anim.update();
